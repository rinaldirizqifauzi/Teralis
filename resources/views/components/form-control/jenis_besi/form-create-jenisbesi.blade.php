<form action="{{ route('jenisbesi.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input id="input_nama_jenisbesi" value="{{ old('jenis_besi') }}" name="jenis_besi" type="text" class="form-control @error('jenis_besi') is-invalid @enderror" placeholder="Masukkan Nama Besi"/>
                @error('jenis_besi')
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label for="image_jenis_besi">Gambar</label>
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="image_jenis_besi">Masukkan Gambar</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <img class="img-preview" width="250px">
                    </div>
                </div>
            </div>
